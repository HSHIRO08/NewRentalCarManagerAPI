...
public class UnitOfWork : IUnitOfWork
{
    ...
    private IRepository<HandoverRecord>? _handoverRecords;
    ...
    public IRepository<HandoverRecord> HandoverRecords => _handoverRecords ??= new Repository<HandoverRecord>(_context);
